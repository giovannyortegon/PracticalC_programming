...
int main(void)
{
	...
	{
		fprintf(stderr, "No row found in the users table "
	...
	if (mysql_num_rows(resultset) > 0)
	{
		...
		printf("Are you sure want to delete this record yes/no: ");
		scanf("%s", k);
		...
		if (strcmp(k, "yes") == 0)
		{
			...
			printf("The user with the given email address is "
					"successfully deleted from the users table\n");
		}
	}
	else
	{
