/*
   condcompile.c
   The program for performing conditional compilation with preprocessor
   directives is shown in the following code snipet
 */
#include <stdio.h>
...
int main()
{
	...
	printf("Discount is %d%% and the total amount after discount is $ %.2f\n", discount, afterDisc);
		...
		#define Kindle 1
	#endif
	printf("You can use the kindle version of the book for %d mount(s)\n", Kindle);
